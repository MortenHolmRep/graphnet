...
with ClusterSubmitter(
		...
		start_up_commands=[os.path.join('source ',os.path.expanduser("$HOME/anaconda3/etc/profile.d/conda.sh"))],
    ) as submitter :

        print("Testing submitter")

        submitter.add(
			command=[os.path.join("python ",os.path.expanduser("$HOME/graphnet/examples/train_model.py"))],
			description="test",
